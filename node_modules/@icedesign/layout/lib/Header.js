...
var IceLayoutHeader = (_temp = _class = function (_PureComponent) {
  _inherits(IceLayoutHeader, _PureComponent);
...
}(_react.PureComponent), _class.displayName = 'IceLayoutHeader', _class.propTypes = {
  /**
   * 主题
   */
